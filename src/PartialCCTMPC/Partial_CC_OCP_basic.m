classdef Partial_CC_OCP_basic < handle
    ...
    methods (Access = public)
        function obj = Partial_CC_OCP_basic(sys, ccPoly, H_verts, CFM, N, gamma, sdp_opts)
            obj.sys = sys;
            obj.ccPoly = ccPoly;
            obj.costFunMan = CFM;
            obj.N = N;
        ...
        function feas_x0 = findFeasibleX0(obj, x0_des, costFun)
            ...
            y(obj.H_params,:) = obj.ys(obj.H_params)*alpha; % Homothetic
    ...
    methods (Access = private)
        ...
        % function constr = constrSetS_partH(obj,y,u,y_p)
