classdef PartialCCTMPC < handle
    ...
    methods (Access = public)
        function obj = PartialCCTMPC(sys, ccPoly, H_verts, CFM, N, gamma, sdp_opts, OCP_opts)
            if nargin == 7; OCP_opts = struct("useBasicOCP",false, "var_convh",false); end
            ...
            if OCP_opts.useBasicOCP
                obj.OCP = Partial_CC_OCP_basic(sys, ccPoly, H_verts, CFM, N, gamma, sdp_opts);
            else
                obj.OCP = Partial_CC_OCP(sys, ccPoly, H_verts, CFM, N, gamma, sdp_opts, OCP_opts.var_convh);
            end
            ...
            obj.H_verts = obj.OCP.H_verts;
            obj.H_params = obj.OCP.H_params;
        end
