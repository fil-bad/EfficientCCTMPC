...
P_polar = Polyhedron(ccPoly.ccpolytope.V,ones(f,1))
P_polar_H = Polyhedron(ccPoly.F);
P_polar.plot("alpha",0.1)
P_polar_H.plot("alpha",0.1,"color",[0,0,1])
%%
V_s = ccPoly.ccpolytope.V';
normV_s = arrayfun(@(i) norm(V_s(:,i)),1:ccPoly.v)
